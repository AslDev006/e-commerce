    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_status', models.CharField(choices=[('phone_step', 'phone_step'), ('code_step', 'code_step'), ('done_step', 'done_step')], default='phone_step', max_length=31)),
                ('auth_type', models.CharField(choices=[], default='via_phone', max_length=31)),
